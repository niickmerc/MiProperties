...
//public class PropertyExceptions implements Writable {
//
...
//    public PropertyExceptions(String civicAddress, int propertyValue, int monthlyRent) {
...
//        if (!(o instanceof PropertyExceptions)) return false;
//
//        PropertyExceptions that = (PropertyExceptions) o;
//
//        return civicAddress.equals(that.civicAddress);
//    }
//
//    @Override
//    public int hashCode() {
